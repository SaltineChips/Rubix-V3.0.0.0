...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendRBXtoblind", 1, "amount" },
    { "sendRBXtoblind", 4, "subtractfeefromamount" },
    { "sendRBXtoanon", 1, "amount" },
    { "sendRBXtoanon", 4, "subtractfeefromamount" },

    { "sendblindtoRBX", 1, "amount" },
    { "sendblindtoRBX", 4, "subtractfeefromamount" },
    ...
    { "sendanontoRBX", 1, "amount" },
    { "sendanontoRBX", 4, "subtractfeefromamount" },
    { "sendanontoRBX", 6, "ringsize" },
    { "sendanontoRBX", 7, "inputs_per_sig" },
    ...
    { "createrawRBXtransaction", 0, "inputs" },
    { "createrawRBXtransaction", 1, "outputs" },
    { "createrawRBXtransaction", 2, "locktime" },
    { "createrawRBXtransaction", 3, "replaceable" },

...
static const uint8_t Rubix_BLOCK_VERSION = 0xA0;
static const uint8_t Rubix_TXN_VERSION = 0xA0;
static const uint8_t MAX_Rubix_TXN_VERSION = 0xBF;
...
inline bool IsRubixTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= Rubix_TXN_VERSION;
}
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsRubixTxVersion(tx.nVersion)) {
...
public:
    ...
    static const int32_t CURRENT_Rubix_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_Rubix_VERSION=0xA0;
...
public:
    ...
    bool IsRubixVersion() const {
        return IsRubixTxVersion(nVersion);
    }
    ...
    {
        return IsRubixTxVersion(nVersion) ? vpout.size() : vout.size();
    }
